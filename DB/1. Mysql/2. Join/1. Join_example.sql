...
-- ex5) departments 와  locations 자연조인(natural join)의 비교 (같은컬럼 : location_id)  ==> 27건
...
where department_id in (30,90) -- department_id=30 or department_id=90 또는 department_id in(30,90)
order by 1;
...
where street_address like '%Vi%' or binary(street_address) like '%St%'
order by 6,4;
